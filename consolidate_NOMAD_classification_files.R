...
list_files = list.files(path=directory,pattern = "compactors_periodic_repeat.tsv",recursive = TRUE)
...
write.table(nomad,"/oak/stanford/groups/horence/Roozbeh/Sponge_project/processed_files/Lemur_10x_compactors_periodic_repeat.tsv",sep="\t",row.names = FALSE,quote = FALSE)
